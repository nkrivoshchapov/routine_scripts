...
parser.add_argument("-n", "--name", dest = "name", default = "result", help="The name for .csv file. Default = result")
parser.add_argument("-d", "--dir", dest = "dir", default = "./*", help="Directory to look for logs. Default = ./*")
args = parser.parse_args()
args.dir = args.dir.replace("log","")
csvf = open(args.name+".csv","w")
for file in glob.glob(args.dir+"log"):
